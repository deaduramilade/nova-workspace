    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 text-white flex">
      ...
      <div className="w-80 border-l border-white/10 bg-black/40 backdrop-blur-xl p-6 hidden lg:block overflow-auto">
        ...
        <div className="space-y-4">
          {[
            { name: "John Doe", status: "Working", location: "Workspace 1", hours: "6.5h" },
            { name: "Alice Smith", status: "Current Weather: 28°C Lagos", location: "Workspace 2", hours: "4.2h" },
            { name: "Michael Chen", status: "Available", location: "Workspace 1", hours: "7.8h" }
          ].map((user, index) => (
